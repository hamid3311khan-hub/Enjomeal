...
// DB
mongoose.connect(process.env.MONGO_URL).then(()=>console.log('✅ MongoDB Connected v8.3')).catch(err => { console.log('Mongo Error:', err); process.exit(1) });

// ROUTES BASIC
app.get('/', (req, res) => res.sendFile(path.join(__dirname, 'public', 'index.html')));
app.get('/api', (req, res) => res.json({ success: true, message: "Eat4Bite API v8.3" }));
