...
mongoose.connect(process.env.MONGO_URL).then(()=>console.log('✅ MongoDB Connected v3.9.5 FIXED')).catch(err => { console.log('Mongo Error:', err); process.exit(1) });
...
server.listen(PORT, ()=> console.log(`🚀 Server v3.9.5 FINAL on ${PORT}`));