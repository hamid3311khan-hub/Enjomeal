...
module.exports = (io) => {
  io.on('connection', (socket) => {
    ...
    socket.on('riderLocation', async (data) => { 
      ...
      // FIX: jis order me rider hai usi room me bhejo
